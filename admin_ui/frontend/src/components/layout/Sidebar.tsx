        ...
        <aside className="w-64 border-r border-border bg-card/50 backdrop-blur flex flex-col h-full">
            ...
            <div className="flex-1 overflow-y-auto py-6 px-3">
                <SidebarGroup title="Overview">
                    ...
                    {isAdmin && <SidebarItem to="/users" icon={Users} label="Users & Resellers" />}
                    {isAdmin && <SidebarItem to="/billing" icon={CreditCard} label="Billing" />}
                    {isAdmin && <SidebarItem to="/wizard" icon={Zap} label="Setup Wizard" />}
                </SidebarGroup>
